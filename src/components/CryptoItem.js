...
function CryptoItem(props) {
  return (
    <div className="my-2 mx-2 ">
      <Link to={`/crypto/${props.uuid} `} className="card shadow p-3 mb-5 card-hover card-width" style={{backgroundColor:props.mode==='light'?'white':'#001429', color:props.mode==='light'?'black':'whitesmoke', textDecoration:'none'}}>
